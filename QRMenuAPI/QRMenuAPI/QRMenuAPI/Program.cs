...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddAuthentication(); //kullanıcıları login ettirecek
        ...
        app.MapControllers();
        {
            ApplicationContext? context = app.Services.CreateAsyncScope().ServiceProvider.GetService<ApplicationContext>();
            if (context !=null)
            {
                ...
                context.SaveChanges();
                RoleManager<IdentityRole>? roleManager = app.Services.CreateAsyncScope().ServiceProvider.GetService<RoleManager<IdentityRole>>();
                if (roleManager != null)
                {
